...
@property (nonatomic, copy)BDImageRequestPerformanceBlock performanceBlock;
@property (nonatomic, copy)BDImageRequestDecryptBlock decryptBlock;

/*
 results
 */
@property (nonatomic, retain)UIImage *image;//返回图，如果支持BDImage默认为BDImage，如果支持BDImage则已经decode
...
@property (nonatomic, strong)BDBaseTransformer *transformer;//图片加工器
